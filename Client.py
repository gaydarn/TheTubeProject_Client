...
label_COMChoice.place(relx=ctkCol_C, rely=0.1, anchor=customtkinter.CENTER)
...
combobox_COMChoice.place(relx=ctkCol_C, rely=0.2, anchor=customtkinter.CENTER)
#*******************Choix du port COM***********************
...
combobox_TrajChoice = customtkinter.CTkComboBox(app, values=Util.listCSVFilesInFolder(os.path.join(os.getcwd(),"Trajectory")),
                                                command=combobox_TrajChoice_callback, width=600)#app.size[1]*0.8)

combobox_TrajChoice.place(relx=ctkCol_C, rely=0.4, anchor=customtkinter.CENTER)
label_TrajChoice = customtkinter.CTkLabel(app, text="Choix de la trajectoire", fg_color="transparent")
label_TrajChoice.place(relx=ctkCol_C, rely=0.3, anchor=customtkinter.CENTER)
#*******************Choix du port COM***********************

#*******************Adresse IP***********************
label_IP = customtkinter.CTkLabel(app, text="Adresse IP", fg_color="transparent")
label_IP.place(relx=ctkCol_C, rely=0.5, anchor=customtkinter.CENTER)
entry_IP = customtkinter.CTkEntry(app, placeholder_text="Enter serveur IP")
entry_IP.place(relx=ctkCol_C, rely=0.6, anchor=customtkinter.CENTER)
#*******************Adresse IP***********************
...
#tKTextBox = customtkinter.CTkTextbox(master=app, width=700, height=200)
